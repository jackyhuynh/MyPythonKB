...
from solution import spiral_traverse_and_vowels


class SpiralTraverseAndVowelsTest(unittest.TestCase):
    def test1(self):
        self.assertEqual(spiral_traverse_and_vowels([['a', 'b', 'c', 'd'], ['e', 'f', 'g', 'h'], ['i', 'j', 'k', 'l']]),
                         [1, 9, 10])
    ...
    def test3(self):
        self.assertEqual(
            spiral_traverse_and_vowels([['w', 'e', 's'], ['i', 'i', 't'], ['l', 'i', 'f'], ['e', '.', '!']]),
            [2, 8, 10, 11, 12])
