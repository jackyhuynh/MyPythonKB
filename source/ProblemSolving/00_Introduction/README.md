...
* **Read Carefully:** Read the problem description 2-3 times. Don't rush!
* **What Goes In?** What information does your code get? (e.g., numbers, words, a list)
* **What Comes Out?** What should your code produce or tell you? (e.g., a total, a yes/no answer, a new list)
* **Try an Example:**
    * If they give you an example, work through it by hand.
    * If not, make up a simple example yourself and figure out what the answer *should* be. This is super important!

### 2. Plan Your Steps (Think Before You Type!)

* **Brainstorm Ideas:** How could you solve this with simple steps? Don't worry about being perfect yet.
* **Write Down Steps (Simple English):** Pretend you're explaining it to a friend.
    * "First, I'll get the user's number."
...
* **Follow Your Plan:** Translate your English steps directly into Python code.
* **Keep it Simple:** Don't try to write everything at once. Write a few lines, then test them if you can.
* **Use Good Names:** Name your variables and functions clearly (e.g., `user_age`, `calculate_total`, not `x`, `y`).
